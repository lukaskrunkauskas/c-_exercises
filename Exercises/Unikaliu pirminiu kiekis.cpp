//Skaičių intervale [L,R] reikia rasti skaičių, kuris turi daugiausiai unikalių pirminių daliklių, o jei tokių skaičių yra daugiau nei vienas, rasti didžiausią.
//
...
//
//Pvz. skaičius 24 turi 4 pirminius daliklius: 2, 2, 2, 3 iš jų unikalūs — 2 ir 3.
...
int main() {
    int l, r, temp, sum=0, did_dal=0, did_sk=0, old_dal=0;
    cin >> l >> r;
    int *A = new int[r+1]();
    set<int> s;
    A[0] = 1;
